...
--6) Tính tổng số lượng và tổng trị giá của các sản phẩm do các nhà cung cấp có tên kết thúc bằng ‘Bicycles’ và tổng trị giá >800000, thông tin gồm
...
--4) Liệt kê các sản phẩm (ProductID, Name) thuộc mô hình sản phẩm áo dài tay với tên bắt đầu với “Long-Sleeve Logo Jersey”, dùng phép IN và EXISTS, (sử dụng
...
--cau 8 Liệt kê các sản phầm không có đơn đặt hàng nào thông tin gồm ProductID, Name, dùng 3 cách Not in, not exists và left join
select P.productID, Name
...
--cau 10. Liệt kê danh sách các khách hàng (customerID, name) có hóa đơn dặt hàng trong năm 2007 nhưng có hóa đơn đặt hàng trong năm 2008.
select [CustomerID]
